...
type UserClient interface {
	CreatUser(ctx context.Context, in *CreatUserRequest, opts ...grpc.CallOption) (*CreatUserRes, error)
...
func (c *userClient) CreatUser(ctx context.Context, in *CreatUserRequest, opts ...grpc.CallOption) (*CreatUserRes, error) {
	out := new(CreatUserRes)
	err := c.cc.Invoke(ctx, "/user.v1.User/CreatUser", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedUserServer) CreatUser(context.Context, *CreatUserRequest) (*CreatUserRes, error) {
...
func _User_CreatUser_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/user.v1.User/CreatUser",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(UserServer).CreatUser(ctx, req.(*CreatUserRequest))
	}
